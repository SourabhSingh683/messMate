...
const OwnerLogin = ({ onLogin }) => {  // Destructure the onLogin prop
  ...
  const handleLoginClick = (e) => {
    ...
    // Mock login logic: Add your actual login validation logic here
    if (email === "try@example.com" && password === "trynew123") {
      console.log("User logged in successfully");
      onLogin();  // Call onLogin prop to update the state in App.js
      navigate("/messOwnerDashboard"); // Redirect to the owner's dashboard
    } else {
